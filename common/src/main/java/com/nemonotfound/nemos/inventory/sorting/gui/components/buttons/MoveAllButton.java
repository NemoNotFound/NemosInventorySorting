...
public class MoveAllButton extends AbstractSingleClickButton<MoveAllButton> {
    ...
    private final ResourceLocation buttonTexture = ResourceLocation.tryBuild(MOD_ID, "textures/gui/sprites/move_all_button.png");
    private final ResourceLocation buttonHoverTexture = ResourceLocation.tryBuild(MOD_ID, "textures/gui/sprites/move_all_button_highlighted.png");
    ...
    protected KeyMapping getHoverKeyMapping() {
        return ModKeyMappings.HOVER_MOVE_ALL.get();
    }
}
