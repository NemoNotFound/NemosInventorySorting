...
public class DropAllButton extends AbstractSingleClickButton {
    ...
    private final Identifier buttonTexture = Identifier.fromNamespaceAndPath(MOD_ID, "drop_all_button");
    private final Identifier buttonHoverTexture = Identifier.fromNamespaceAndPath(MOD_ID, "drop_all_button_highlighted");
    ...
    public void onClick(@NotNull MouseButtonEvent mouseButtonEvent, boolean isDoubleClick) {
        interactWithAllItems(ContainerInput.THROW, 1);
    }
    ...
    protected KeyMapping getHoverKeyMapping() {
        return SortingKeyMappings.HOVER_DROP_ALL.get();
    }
}
