...
public class NemosInventorySortingClientCommon {
    ...
    public static void init() {
        ...
        ConfigService.getInstance().writeConfig(false, GENERAL_CONFIG_PATH, com.nemonotfound.nemos.inventory.sorting.config.model.SettingsConfig.INSTANCE);
        ConfigService.getInstance().writeConfig(false, LOCKED_SLOTS_CONFIG_PATH, com.nemonotfound.nemos.inventory.sorting.config.model.LockedSlotsConfig.INSTANCE);
